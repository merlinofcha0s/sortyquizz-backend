...
import { UserPackComponent } from 'app/entities/user-pack/user-pack.component';
...
describe('Component Tests', () => {
  describe('UserPack Management Component', () => {
    let comp: UserPackComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(UserPackComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.userPacks && comp.userPacks[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
